...
final models = [ /* あなたのモデルのリスト */ 
  ...
  Tweet('イエス・キリスト', 'icon7.png', 'もとめよ、さらばあたえられん。', ),
  Tweet('ボンちゃん', 'icon8.png', '命を賭けて友達を迎えに行く友達を...見捨てておめェら明日食う飯が美味ェかよ！！！！',),
  Tweet('フランス皇帝 ナポレオン・ボナパル', 'icon9.png', '余の辞書に不可能という言葉はない。', ),
  ...
  Tweet('ゲーテ', 'icon1.png', '急がず休まず', ),
  Tweet('シャンフォール（作家）', 'icon1.png', '機会が二度扉を叩くなどとは考えるな。', ),
  Tweet('アルベルト・アインシュタイン', 'icon1.png', '想像力は知識よりも重要である。', ),
  Tweet('古代ローマの歴史家 リヴィウス', 'icon1.png', '遅くとも、何もやらないよりは、やるのがよろしい。', ),
  Tweet('劇作家 ウィリアム・シェイクスピア', 'icon1.png', '逆境も考え方によっては素晴らしいもの。', ),
  Tweet('ギル・アメリオ', 'icon1.png', '自分の力でどうにもならないことは、心配しても意味がない。', ),
  Tweet('発明家 スティーブンソン', 'icon1.png', '我々の目的は成功ではなく、失敗にたゆまずして進むことである。', ),
  Tweet('川上量生（ニコニコ創業者）', 'icon1.png', 'チャンスがあるのに行動しないことで終わってしまうのは惜しい', ),
  Tweet('ジャック・ドーシー（Twitter創業者）', 'icon1.png', '私が学んだ最大の教訓は、とにかく始めてみるということです。今すぐ、小さくてもいいから、とにかく始めて、やり続ける、シンプルな原則です。', ),
  Tweet('マーク・ザッカーバーグ', 'icon1.png', '最大のリスクは、リスクを取らないことだ', ),
  Tweet('ナイチンゲール', 'icon1.png', 'あなた方は進歩し続けない限りは、退歩していることになるのです', ),
  Tweet('孔子', 'icon1.png', '人生は単純なものなのに、我々が複雑にしようとしているのです', ),
  Tweet('パブロ・ピカソ', 'icon1.png', '行動がすべての成功への基本的な鍵である。', ),
  Tweet('トーマス・エジソン', 'icon1.png', '失敗なんかしちゃいない。うまくいかない方法を一万通り見つけただけだ。', ),
  Tweet('ウォルト・ディズニー', 'icon1.png', '夢見ることができれば、それは実現できる。', ),
  Tweet('リオネル・メッシ', 'icon1.png', '努力すれば報われる？そうじゃないだろ。報われるまで努力するんだ', ),
  Tweet('ジョン・ウッデン', 'icon1.png', '1日ずつ、人生最高の日にしよう。', ),
  Tweet('ソクラテス', 'icon1.png', '簡単すぎる人生に、生きる価値などない。', ),
