...
final models = [ /* あなたのモデルのリスト */ 
  ...
  Tweet('ウソップ', 'usoppu.png', '今ここで全力で戦わなかった俺に、あいつらと同じ船に乗る資格なんてあるはずねぇ！あいつらと全力で笑い合っていいはずがねえ！',),
  ...
  Tweet('E班長:大槻', 'hantyo.png', '明日からがんばるんじゃない、今日、今日だけがんばるんだっ。今日をがんばった者、今日をがんばり始めた者にのみ、明日が来るんだよ', ),
